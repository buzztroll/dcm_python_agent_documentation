...
.. literalinclude:: files/agent_scripts.txt

However the scripts in the **/dcm/bin** directory are not designed to be edited directly as these scripts are overwritten during an upgrade.
