...
html_title = "Dell Cloud Manager Python Agent"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "DCM Python Agent"
...
latex_documents = [
  ('index', 'python_agent.tex', u'DCM Python Agent',
   u'Dell', 'manual'),
]
